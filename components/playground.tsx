    ...
    const conversationToolbar = (
      <div className="w-full absolute left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2">
        ...
        >
          ...
          />
          <Button
            className="flex items-center justify-center px-3 rounded-[4px] bg-red-700 hover:bg-red-800 text-white focus-visible:ring-2 focus-visible:ring-red-400"
            onClick={() =>
      ...
      <div className="absolute top-1/2 -translate-y-1/2">
        ...
        >
          <Button
            state="primary"
            size="large"
            className={`relative w-full text-base text-white bg-red-700 hover:bg-red-700 focus-visible:ring-2 focus-visible:ring-red-400 ${isLoading ? "pointer-events-none" : ""
              }`}
            onClick={() =>
              onConnect(roomState === ConnectionState.Disconnected)
            }
